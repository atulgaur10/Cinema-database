...
INSERT INTO seats (rowq, number, room_id)
...
and screenings.start_time between '2017-10-01' and '2017-10-31';
...
select customer_id, count(*) from reserved_seat r
join bookings b on r.booking_id= b.id
group by customer_id;

select f.name, f.lenght_min ,count(*) from screenings s
join films f on s.film_id = f.id
group by f.name,f.lenght_min
having lenght_min > 120;
